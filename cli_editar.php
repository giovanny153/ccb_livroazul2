...
echo $id."<br>";
echo $igreja."<br>";
echo $tipoRelatorio."<br>";
echo $data."<br>";
echo $destacador."<br>";
echo $obs."<br>";
echo $assinatura."<br>";
echo $preenchimento."<br>";
?>  
  ...
  <form action="banco_de_dados/cli_create.php" method="post" class="col s12">
    <fieldset class="formulario" style="padding: 15px">
      ...
      <div class="input-field col s12">
        ...
        <select name='igreja' >         
          <option selected value = <?php echo $igreja ?> ><?php echo $igreja ?></option>
      ...
      <div class="input-field col s12">
        ...
        <select name='tipoRelatorio'>          
          <option selected value="<?php echo $tipoRelatorio ?>"><?php echo $tipoRelatorio ?></option>
      ...
      <div class ="input-field col s12">
        ...
        <input type="date" name="data" id="data" maxlength="40" value="<?php echo $data ?>">
      ...
      <div class="input-field col s12">
        ...
        <select name='destacador'>          
          <option disabled selected value="<?php echo $destacador ?>"><?php echo $destacador ?></option>
      ...
      <div class ="input-field col s12">
        ...
        <input type="text" name="obs" id="obs" maxlength="400" value="<?php echo $obs?>">
